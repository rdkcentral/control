...
// [<version>,<type>,<method>,<result>,<discovered>,<name>,<bluez_retries>,<bluez_msg1>,<bluez_msg2>,<bluez_msg3>,<timestamp>]
// <version>       - version of the marker format.
...
// <timestamp>     - wall-clock time the marker was generated, in epoch milliseconds (makes each marker value unique)
#define MARKER_RCU_PAIRING_ATTEMPT "ctrlm.rcu.pairing.attempt_accum"
#define MARKER_RCU_PAIRING_ATTEMPT_VERSION 2
...
#define MARKER_IRDB_AUTOLOOKUP_RESULT "ctrlm.irdb.autolookup.result_accum" // format: <version>,<stb_vendor>,<stb_bitmask>,<tv>,<tv_code_count>,<avr_code_count>,<result>,<timestamp>
#define MARKER_IRDB_AUTOLOOKUP_RESULT_VERSION 1
#define MARKER_IRDB_MANUAL_RESULT     "ctrlm.irdb.manual.result_accum"     // format: <version>,<stb_vendor>,<stb_bitmask>,<method>,<result>,<timestamp>
#define MARKER_IRDB_MANUAL_RESULT_VERSION 1
#define MARKER_IRDB_PROGRAM_RESULT    "ctrlm.irdb.program.result_accum"    // format: <version>,<result>,<fail_reason>,<rcu_bitmask>,<vendor_name>,<vendor_bitmask>,<timestamp>
#define MARKER_IRDB_PROGRAM_RESULT_VERSION 1
#define MARKER_IRDB_VENDOR_SET        "ctrlm.irdb.vendor_set_accum"        // format: <version>,<set_result>,<rcu_bitmask>,<vendor_name>,<vendor_bitmask>,<supported>,<timestamp>
#define MARKER_IRDB_VENDOR_SET_VERSION 1
