...
public:
    /**
     * This function is used to get the Thunder CEC instance, as it is a Singleton.
     * @return The instance of the Thunder CEC, or NULL on error.
     */
    static ctrlm_thunder_plugin_cec_t *getInstance();
