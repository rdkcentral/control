...
public:
    /**
     * This function is used to get the Thunder System Audio Player instance, as it is a Singleton.
     * @return The instance of the Thunder System Audio Player, or NULL on error.
     */
    static ctrlm_thunder_plugin_system_audio_player_t *getInstance();
...
protected:
    /**
     * System Audio Player Thunder Plugin Default Constructor
     */
