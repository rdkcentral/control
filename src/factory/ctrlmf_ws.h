...
typedef void (*ctrlmf_ws_connected_t)(void *data);
typedef void (*ctrlmf_ws_disconnected_t)(void *data);

typedef struct {
   ctrlmf_ws_connected_t    connected;
   ctrlmf_ws_disconnected_t disconnected;
   void *                   data;
} ctrlmf_ws_callbacks_t;
