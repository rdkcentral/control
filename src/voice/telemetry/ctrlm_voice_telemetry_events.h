...
public:
    ...
    bool update_on_session_end(bool result, int32_t end_reason_stream, int32_t end_reason_session, int32_t ret_code_protocol, int32_t server_return_code, const std::string &server_message, int32_t time_stream_len_exp);
