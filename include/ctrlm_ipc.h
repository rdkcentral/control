...
typedef enum {
   ...
   CTRLM_RCU_IARM_EVENT_VALIDATION_STATUS            = 8, ///< Generated when the validation status changes
   CTRLM_RCU_IARM_EVENT_CONFIGURATION_COMPLETE      =  9, ///< Generated upon completion of controller configuration
   CTRLM_RCU_IARM_EVENT_FUNCTION                    = 10, ///< Generated when a function is performed on a controller
   CTRLM_RCU_IARM_EVENT_KEY_GHOST                   = 11, ///< Generated when a ghost code is received from a controller
   CTRLM_RCU_IARM_EVENT_RIB_ACCESS_CONTROLLER       = 12, ///< Generated when a controller accesses a RIB entry
   CTRLM_VOICE_IARM_EVENT_SESSION_BEGIN             = 13, ///< Voice session began
   CTRLM_VOICE_IARM_EVENT_SESSION_END               = 14, ///< Voice session ended
   CTRLM_VOICE_IARM_EVENT_SESSION_RESULT            = 15, ///< Result of a voice session
   CTRLM_VOICE_IARM_EVENT_SESSION_STATS             = 16, ///< Statistics from a voice session
   CTRLM_VOICE_IARM_EVENT_SESSION_ABORT             = 17, ///< Voice session was aborted (denied)
   CTRLM_VOICE_IARM_EVENT_SESSION_SHORT             = 18, ///< Voice session did not meet minimum duration
   CTRLM_VOICE_IARM_EVENT_MEDIA_SERVICE             = 19, ///< Voice session results in media service event
   CTRLM_DEVICE_UPDATE_IARM_EVENT_READY_TO_DOWNLOAD = 20, ///< Indicates that a device has an update available
   CTRLM_DEVICE_UPDATE_IARM_EVENT_DOWNLOAD_STATUS   = 21, ///< Provides status of a download that is in progress
   CTRLM_DEVICE_UPDATE_IARM_EVENT_LOAD_BEGIN        = 22, ///< Indicates that a device has started to load an image
   CTRLM_DEVICE_UPDATE_IARM_EVENT_LOAD_END          = 23, ///< Indicates that a device has completed an image load
   CTRLM_RCU_IARM_EVENT_BATTERY_MILESTONE           = 24, ///< Indicates that a battery milestone event occured
   CTRLM_RCU_IARM_EVENT_REMOTE_REBOOT               = 25, ///< Indicates that a remote reboot event occured
   CTRLM_RCU_IARM_EVENT_RCU_REVERSE_CMD_BEGIN       = 26, ///< Indicates that a RCU Reverse Command started
   CTRLM_RCU_IARM_EVENT_RCU_REVERSE_CMD_END         = 27, ///< Indicates that a RCU Reverse Command ended 
   CTRLM_RCU_IARM_EVENT_CONTROL                     = 28, ///< Generated when a control event is received from a controller
   CTRLM_VOICE_IARM_EVENT_JSON_SESSION_BEGIN        = 29, ///< Generated on voice session begin, payload is JSON for consumption by Thunder Plugin
   CTRLM_VOICE_IARM_EVENT_JSON_STREAM_BEGIN         = 30, ///< Generated on voice stream begin, payload is JSON for consumption by Thunder Plugin
   CTRLM_VOICE_IARM_EVENT_JSON_KEYWORD_VERIFICATION = 31, ///< Generated on voice keyword verification, payload is JSON for consumption by Thunder Plugin
   CTRLM_VOICE_IARM_EVENT_JSON_SERVER_MESSAGE       = 32, ///< Generated on voice server message, payload is JSON for consumption by Thunder Plugin
   CTRLM_VOICE_IARM_EVENT_JSON_STREAM_END           = 33, ///< Generated on voice stream end, payload is JSON for consumption by Thunder Plugin
   CTRLM_VOICE_IARM_EVENT_JSON_SESSION_END          = 34, ///< Generated on voice session end, payload is JSON for consumption by Thunder Plugin
   CTRLM_RCU_IARM_EVENT_RCU_STATUS                  = 35, ///< Generated when something changes in the BLE remote
   CTRLM_RCU_IARM_EVENT_RF4CE_PAIRING_WINDOW_TIMEOUT = 36, ///< Indicates that a battery milestone event occured
   CTRLM_RCU_IARM_EVENT_FIRMWARE_UPDATE_PROGRESS    = 37, ///< Generated when an milestone is reached for remote firmware upgrade 
