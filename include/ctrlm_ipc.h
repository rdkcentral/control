...
typedef enum {
   ...
   CTRLM_RCU_IARM_EVENT_VALIDATION_BEGIN            =  5, ///< deprecated
   CTRLM_RCU_IARM_EVENT_VALIDATION_KEY_PRESS        =  6, ///< deprecated
   CTRLM_RCU_IARM_EVENT_VALIDATION_END              =  7, ///< deprecated
   CTRLM_RCU_IARM_EVENT_CONFIGURATION_COMPLETE      =  8, ///< deprecated
   ...
   CTRLM_VOICE_IARM_EVENT_SESSION_BEGIN             = 12, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_SESSION_END               = 13, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_SESSION_RESULT            = 14, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_SESSION_STATS             = 15, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_SESSION_ABORT             = 16, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_SESSION_SHORT             = 17, ///< deprecated
   CTRLM_VOICE_IARM_EVENT_MEDIA_SERVICE             = 18, ///< deprecated
   ...
   CTRLM_RCU_IARM_EVENT_RF4CE_PAIRING_WINDOW_TIMEOUT = 35, ///< deprecated
