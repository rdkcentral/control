...
#define RF4CE_RCU_ID_RANGE_MAX (NETWORK_ID_BASE_BLE)
...
} ctrlm_main_queue_msg_rf4ce_timeout_key_release_t;
...
public:
   ...
   void                                 rfc_fetch_completed_handler(void);
...
private:
   ...
   sem_t                                   reverse_cmd_event_pending_semaphore_;
