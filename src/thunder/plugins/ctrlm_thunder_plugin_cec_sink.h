...
public:
    /**
     * This function is used to get the Thunder CEC Sink instance, as it is a Singleton.
     * @return The instance of the Thunder CEC Sink, or NULL on error.
     */
    static ctrlm_thunder_plugin_cec_sink_t *getInstance();
